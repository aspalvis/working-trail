      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-10 flex-wrap gap-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">View and edit all entries</p>
          </div>
          <Link
            href="/"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200/50 dark:border-gray-700/50">
            ...
            {filteredEntries.length === 0 && (
              <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                {selectedProject
                  ? `No entries for project "${selectedProject}"`
            ...
            <div className="space-y-4">
              ...
              <div className="text-sm text-gray-600 bg-indigo-50 p-3 rounded-lg">
                <div className="flex justify-between">
                  <span>Rate:</span>
                  <span className="font-medium">{editingEntry.hourlyRate.toFixed(2)} €/h</span>
                </div>
