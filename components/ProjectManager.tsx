...
export default function ProjectManager({ onClose, onProjectCreated }: ProjectManagerProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-6 md:p-10 border border-gray-100 dark:border-gray-800 max-w-3xl w-full animate-slide-in max-h-[90vh] overflow-y-auto">
