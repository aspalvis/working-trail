...
export default function ManualTimeEntry({ onClose, onSaved }: ManualTimeEntryProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-6 md:p-10 border border-gray-100 dark:border-gray-800 max-w-2xl w-full animate-slide-in max-h-[90vh] overflow-y-auto">
